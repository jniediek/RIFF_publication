...
case 1
	if (isa(varargin{1},'FLANKING_BAND_IND'))
	    flank = varargin{1}; 
    end
otherwise
    treat_error('Wrong input argument to FLANKING_BAND_IND constructor');
end 