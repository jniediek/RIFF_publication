...
Search_Manager=Output_manager(BUF_SAMP_RATE,SEARCH_BUF_SIZE);
...
function  h=run_search(fig_handle)
global TRIAL_DUR_CHANGED;
global SAMP_RATE_CHANGED;
global EARS_CHANGED;
global SIGNAL_CHANGED;
...
for k=1:len
    ...
    SEARCH_INITIALIZED_DATA_STRUCT{k}=zeros(1,4);
end
