...
function  crid_create_plot_after(fig_data,values_table,buf_samp_rate,p_handle,plot_index,electrode_num,panel_num)
...
for k=panel_num %going through the 4 panels
