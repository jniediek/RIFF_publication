...
%  CHECK_IF_LEGAL checks the legacy of the given val as a STime_comp-object property.
%   [VALID_FLAG,ERR,IS_FORMULA]=CHECK_IF_LEGAL(COMP,PROP,VAL,DEF_ARR,
%   VAR_ARR) checks that VAL is a legal value for the STime_comp-object property-PROP.
...
%                 
   otherwise
        [valid_flag,err,is_formula]=check_if_legal(comp.String_comp,prop,val,def_arr,var_arr);
   end
