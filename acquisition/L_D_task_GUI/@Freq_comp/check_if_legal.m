...
%  CHECK_IF_LEGAL checks the legacy of the given val as a Freq_comp-object property.
%   [VALID_FLAG,ERR,IS_FORMULA]=CHECK_IF_LEGAL(COMP,PROP,VAL,DEF_ARR,
%   VAR_ARR) checks that VAL is a legal value for the Freq_comp-object property-PROP.
