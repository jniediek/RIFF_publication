function S = StimulusListNBN(filename,dbr) %bf,fra_att, ssa_att, repeats
...
rword = {'nbn_3000Hz';'nbn_4242.6407Hz';'nbn_6000Hz';'nbn_8485.2814Hz';'nbn_12000Hz';'nbn_16970.5627Hz'};
% rewlen = 2000*60;
rewlen = 2000;
