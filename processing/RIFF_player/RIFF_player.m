...
function varargout = RIFF_player(varargin)
% RIFF_PLAYER MATLAB code for RIFF_player.fig
%      RIFF_PLAYER, by itself, creates a new RIFF_PLAYER or raises the existing
%      singleton*.
%
%      H = RIFF_PLAYER returns the handle to a new RIFF_PLAYER or the handle to
%      the existing singleton*.
%
%      RIFF_PLAYER('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in RIFF_PLAYER.M with the given input arguments.
%
%      RIFF_PLAYER('Property','Value',...) creates a new RIFF_PLAYER or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before RIFF_player_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to RIFF_player_OpeningFcn via varargin.
%
...
% Begin initialization code - DO NOT EDIT
    ...
    gui_State = struct('gui_Name',       mfilename, ...
                       ...
                       'gui_OpeningFcn', @RIFF_player_OpeningFcn, ...
                       'gui_OutputFcn',  @RIFF_player_OutputFcn, ...
                       'gui_LayoutFcn',  [] , ...
                       'gui_Callback',   []);
...
function RIFF_player_OpeningFcn(hObject, ~, handles, varargin)
